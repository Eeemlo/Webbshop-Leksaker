...
* 
* Ändringar gjorda: 
Tagit bort utskrift till innerHTML så att endast antalet varor skrivs ut i small-basket
*
*/
...
function showSmallBasket() {
    if (document.getElementById("small-basket")) {
        ...
        if (basketItems.length > 0) {
            ...
            smallBasketEl.innerHTML = numOfItems;
        ...
        if (basketItems.length > 0) {
            ...
            for (let i = 0; i < basketItems.length; i++) {
                ...
                checkoutEl.innerHTML += "<tr>" +
                    "<td class='bild'><img src='" + artImage + "' alt='Produktbild för " + artName + "' />" +
                    "<td class=''artikel>" + artId + "</td>" +
                    "<td class='vara'>" + artName + "</td>" +
                    "<td class='antal'>" + numItems + " st.</td>" +
                    "<td class='pris'>" + itemSumCost + ":-</td>" +
                    "</tr>";
            }
